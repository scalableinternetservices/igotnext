...
# Lambda URIs are "{+lambda}/{+function}" e.g. "igotnext/ping".
# We also support path matching at the root e.g. "igotnext" but these require definining separate "_root" terraform resources.
