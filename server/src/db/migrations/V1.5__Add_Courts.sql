insert into `court` (`courtname`,`longitude`,`latitude`,`lobby`,`parkParkID`,`roster`,`featured`) values ('UCLA',-117.307896,33.302269,0,1,"",true);
insert into `court` (`courtname`,`longitude`,`latitude`,`lobby`,`parkParkID`,`roster`,`featured`) values ('UCSB',-117.307896,33.302269,0,1,"",false);
