...
usage="Usage: deploy-ecs.sh [igotnext-app-web|igotnext-app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/igotnext:$2"
...
aws ecs update-service --cluster igotnext \
  --no-cli-pager \
  --region "$ecs_region" \
